<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowReward.aspx.cs" Inherits="lessonweb.web.pilotapp.ShowReward" %>
            ...
            <div class="ui-corner-all custom-corners">
                ...
                <div class="ui-body ui-body-a">
                    <table class="ui-responsive" id="table-column-toggle" data-role="table" data-mode="columntoggle:none">
                        <tbody>
                            <tr>
                                <td style="text-align:center;vertical-align:middle"><img src="<%=Utils.GetLogoURL(rd.Logo) %>" style="width:40px;height:40px"/></td>
                                <td>
                                    <p><%=rd.RewardDesc%></p>
                                    <p><%=rd.getRewardDetail()%></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <%for (int i = 0; i < requirements.Count; i++)
                      {
                        ...
                        <%}%>
                            ...
                            <h2 class="<%=GetRewardHeaderClass(whenAch!= DateTime.MinValue) %>"><%=td.AchievementName%></h2>
                            <p><%=td.AchievementDesc%></p></a>
                        </li>
                    <%} %>
                </ul>
                <% }
