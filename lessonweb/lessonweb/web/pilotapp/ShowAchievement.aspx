<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowAchievement.aspx.cs" Inherits="lessonweb.web.pilotapp.ShowAchievement" %>
    ...
    <div data-role="page" id="homepage">
        <div data-role="panel" id="navPanel" data-display="push">
            <ul data-role="listview">
                ...
                <li data-theme="b">Achievement</li>
            </ul>
        </div>
        ...
        <div data-role="header" data-position="fixed">
            ...
            <h1 class="ui-title">Achievement</h1>
        ...
        <div data-role="content" id="ContentPage">
            ...
            <div class="ui-corner-all custom-corners">
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; vertical-align: middle">
                                    <img src="<%=Utils.GetLogoURL("Trophy") %>" style="width: 40px; height: 40px" /></td>
                                <td>
                                    <p><%=rd.AchievementDesc%></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <%if (requirements.Count<AchievementDefinition>() > 0)
                    {%>
                ...
                <%if (taskrequirements.Count<TaskDefinition>() > 0)
                    {%>
                <div class="ui-bar ui-bar-b ui-bar-gray">
                ...
                <ul style="margin-top: 0px" data-role="listview" data-inset="true">
                    <%for (int i = 0; i < taskrequirements.Count; i++)
                        {
                            TaskDefinition td = (TaskDefinition)taskrequirements[i]; %>
                    <li <%
                        ...
                        <a href="ShowTask.aspx?TaskID=<%=td.TaskID %>">
                            <h2 class="<%=GetAchievementHeaderClass(whenAch != DateTime.MinValue) %>"><%=td.TaskName%></h2>
